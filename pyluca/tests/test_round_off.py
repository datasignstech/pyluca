...
class TestRoundOff(TestCase):
    def test_round_off(self):
        ...
        self.assertEqual(round_off_amount(1000.0000001), 1000.0000001)
        self.assertNotEqual(round_off_amount(1000.00000001), 1000.00000001)
        self.assertEqual(round_off_amount(1000.00000001), 1000.0000001)
        self.assertEqual(round_off_amount(1000.00000019398493849898928), 1000.0000002)
        self.assertEqual(round_off_amount(1000.0000001999999), 1000.0000002)
        # following assertion is weird, because of python floating issue
        self.assertEqual(round_off_amount(1000.00000019999999), 1000.0000003)
        # weird end

        self.assertEqual(round_off_amount(1000.00000010001), 1000.0000002)
        self.assertEqual(round_off_amount(1000.000000100001), 1000.0000002)
        self.assertEqual(round_off_amount(1000.0000001000001), 1000.0000002)

        # following assertion is weird, because of python floating issue
        self.assertEqual(round_off_amount(1000.00000010000001), 1000.0000001)
        # weird end
